...
// Calendar
        methods_calendar = {
             ...
             */
                ...
                HTML.push('         <input type="text" name="DOPBCP-start-date-view'+ID+'" id="DOPBCP-start-date-view'+ID+'" value="" class="form-control" />');
                HTML.push('         <input type="hidden" name="DOPBCP-start-date'+ID+'" id="DOPBCP-start-date'+ID+'" value="" class="form-control" />');
                HTML.push('     </div>');
                HTML.push('     <div class="dopbcp-input-wrapper">');
                HTML.push('         <label for="DOPBCP-end-date-view'+ID+'">'+DateEndLabel+'</label>');
                HTML.push('         <input type="text" name="DOPBCP-end-date-view'+ID+'" id="DOPBCP-end-date-view'+ID+'" value="" disabled="disabled" class="form-control" />');
             ...
             */
                ...
                $('.DOPBCPCalendar-navigation .dopbcp-week .dopbcp-day', Container).width(parseInt(($('.DOPBCPCalendar-navigation .dopbcp-week', Container).width()-parseInt($('.DOPBCPCalendar-navigation .dopbcp-week', Container).css('padding-left'))+parseInt($('.DOPBCPCalendar-navigation .dopbcp-week', Container).css('padding-right')))/7) -3);
        ...
        methods_form = {
             ...
             */
                ...
                if (type === 'days'){
                    HTML.push('     <div class="dopbcp-input-wrapper">');
                    HTML.push('         <label for="DOPBCP-start-date-view'+ID+'">'+DateStartLabel+'</label>');
                    HTML.push('         <input class="form-control" type="text" name="DOPBCP-start-date-view'+ID+'" id="DOPBCP-start-date-view'+ID+'" value="'+(DateType === 1 ? sMonthText+' '+sDay+', '+sNYear:sDay+' '+sMonthText+' '+sNYear)+'" />');
                    HTML.push('         <input type="hidden" name="DOPBCP-start-date'+ID+'" id="DOPBCP-start-date'+ID+'" value="'+sNYear+'-'+sMonth+'-'+sDay+'" />');
                    HTML.push('     </div>');
                    HTML.push('     <div class="dopbcp-input-wrapper">');
                    HTML.push('         <label for="DOPBCP-end-date-view'+ID+'">'+DateEndLabel+'</label>');
                    HTML.push('         <input class="form-control" type="text" name="DOPBCP-end-date-view'+ID+'" id="DOPBCP-end-date-view'+ID+'" value="'+(DateType === 1 ? eMonthText+' '+eDay+', '+eNYear:eDay+' '+eMonthText+' '+eNYear)+'" />');
                ...
                if (type === 'days'){
                    HTML.push('     <div class="dopbcp-input-wrapper dopbcp-input-status-wrapper select">');
                    ...
                    HTML.push('         </select>');
                    HTML.push('     </div>');
                    HTML.push('     <div class="dopbcp-input-wrapper dopbcp-input-price-wrapper hidden">');
                    HTML.push('         <label for="DOPBCP-price">'+PriceLabel+' '+Currency+'</label>');
                    HTML.push('         <input type="text" name="DOPBCP-price" id="DOPBCP-price" value="" class="form-control" />');
                    HTML.push('     </div>');
                    HTML.push('     <div class="dopbcp-input-wrapper hidden">');
                    HTML.push('         <label for="DOPBCP-promo">'+PromoLabel+' '+Currency+'</label>');
                    HTML.push('         <input type="text" name="DOPBCP-promo" id="DOPBCP-promo" value="" disabled="disabled" class="form-control" />');
                    HTML.push('     </div>');
                    HTML.push('     <div class="dopbcp-input-wrapper hidden">');
                    HTML.push('         <label for="DOPBCP-available">'+AvailableLabel+'</label>');
                    HTML.push('         <input type="text" name="DOPBCP-available" id="DOPBCP-available" value="1" class="form-control" />');
                    HTML.push('     </div>');
                }
                HTML.push('     <div class="dopbcp-input-wrapper hidden">');
                HTML.push('         <label class="dopbcp-for-textarea" for="DOPBCP-info">'+InfoLabel+'</label>');
                HTML.push('         <textarea name="DOPBCP-info" id="DOPBCP-info" rows="5" cols="" class="form-control"></textarea>');
                HTML.push('     </div>');
                HTML.push('     <div class="dopbcp-input-wrapper hidden">');
                HTML.push('         <label class="dopbcp-for-textarea" for="DOPBCP-notes">'+NotesLabel+'</label>');
                HTML.push('         <textarea name="DOPBCP-notes" id="DOPBCP-notes" rows="5" cols="" class="form-control"></textarea>');
                HTML.push('     </div>');

                if ((startDate !== endDate
                                && type === 'days')){
                    HTML.push('     <div class="dopbcp-input-wrapper dopbcp-last checkbox hidden">');
                ...
                HTML.push('   <input type="button" name="DOPBCP-submit" id="DOPBCP-submit" class="btn btn-primary" title="Submit" value="'+methods_form.text['submit']+'" />');
                HTML.push('   <input type="button" name="DOPBCP-reset" id="DOPBCP-reset" class="btn btn-primary dopbcp-reset" title="Reset" value="'+methods_form.text['reset']+'" />');
                HTML.push('</div>');
                /*
                 * ***************************************************** End form buttons.
                 */
...
// Schedule
        methods_schedule = {
             ...
             */
                ...
                $.post(saveURL, {reservations: JSON.stringify(Schedule)}, function(data){
                    if (year === yearEndSave
                            && month === monthEndSave){
