        ...
        var Data = {"loadURL": "dopbcp/php-file/load.php",
                    ...
                    "reservation": {"data": {},
                                    "text": {"price": "Price",
                                             ...
                                             "minimumStay": "Must be over minimum nightly stay."}},
                    "search": {"data": {},
...
// 2. Schedule
        ...
        methods_schedule = {
             ...
             */
                ...
                $.get(ajaxLoadURL, {dopbcp_calendar_id: ID,
...
// 10. Days
        ...
        methods_days = {
             ...
             */
                ...
                console.log("minNoDays", minNoDays);
                ...
                if (methods_search.days.validate(ciDay)
                    ...
                    console.log("noDays", minNoDays);

                    if (noDays < minNoDays){
                        console.log("noDays < minNoDays");
                        methods_reservation.toggleMessages(methods_reservation.text['minimumStay'], '');
                        return false;
                    }
             ...
             */
                ...
                for (i=0; i<selectedDays.length-(methods_days.data['morningCheckOut'] ? 1:0); i++){
                    ...
                    if (schedule[currDay] !== undefined
                        ...
                        // Monthly and weekly price and special
                        // console.log(schedule[currDay]);
                        if(schedule[currDay]['status'] == 'special'){
                            price = parseFloat(schedule[currDay]['special_price']);
                        } else if(selectedDays.length >= 30){
                            price = parseFloat(schedule[currDay]['monthly_price']);
                        } else if(selectedDays.length >= 7){
                            price = parseFloat(schedule[currDay]['weekly_price']);
                        } else {
                            price = parseFloat(schedule[currDay]['price']);
                        }


                        console.log("method_days.price", price);
             ...
             */
                ...
                for (i=0; i<selectedDays.length-(methods_days.data['morningCheckOut'] ? 1:0); i++){
                    ...
                    history[currDay]['reservation_id'] = schedule[currDay]['reservation_id'];
                }
...
// 12. Sidebar
        ...
        methods_sidebar = {
             ...
             */
                ...
                HTML.push('                             </td></tr>');
                HTML.push('                             <tr>');
                // HTML.push('                             <tr><td class="dopbcp-column-separator dopbcp-column5"></td>');
        ...
        methods_search = {
            ...
            days: {
                 ...
                 */
                    ...
                    HTML.push('             <input type="text" class="form-control" name="DOPBCPCalendar-check-in-view'+ID+'" id="DOPBCPCalendar-check-in-view'+ID+'" class="DOPBCPCalendar-check-in-view" value="'+methods_search.text['checkIn']+'" />');
                    ...
                    if (methods_days.data['multipleSelect']){
                        HTML.push('     <div class="dopbcp-input-wrapper DOPBCPCalendar-left">');
                        HTML.push('         <input type="text" class="form-control" name="DOPBCPCalendar-check-out-view'+ID+'" id="DOPBCPCalendar-check-out-view'+ID+'" class="DOPBCPCalendar-check-out-view" value="'+methods_search.text['checkOut']+'" />');
...
// 19. Reservation
        ...
        methods_reservation = {
             ...
             */
                ...
                console.log("schedule[ciDay]['minimum_stay']", schedule[ciDay]['minimum_stay'] + 1)

                if (!methods_days.getAvailability(ciDay, coDay, schedule[ciDay]['minimum_stay'] + 1)){
...
// 21. Form
        ...
        methods_form = {
             ...
             */
                ...
                HTML.push('<div id="DOPBCPCalendar-form'+ID+'" class="dopbcp-module form-end">');
                    ...
                    for (i=0; i<form.length; i++){
                        ...
                        switch (formField['type']){
                            ...
                            case 'text':
                                ...
                                HTML.push('     </div>');
                                HTML.push('     <label for="DOPBCPCalendar-form-field'+ID+'_'+formField['id']+'">'+formField['translation']+(formField['required'] === 'true' ? ' <span class="dopbcp-required">*</span>':'')+'</label>');
                                HTML.push('     <input class="form-control" type="text" name="DOPBCPCalendar-form-field'+ID+'_'+formField['id']+'" id="DOPBCPCalendar-form-field'+ID+'_'+formField['id']+'" value="" />');
                                break;
                            case 'textarea':
                                /*
                                 * Textarea field.
                 ...
                 */
                HTML.push(' <div class="dopbcp-input-wrapper">');
                HTML.push('     <input type="submit" name="DOPBCPCalendar-submit'+ID+'" id="DOPBCPCalendar-submit'+ID+'" class="btn btn-primary DOPBCPCalendar-hidden" value="'+methods_order.text['book']+'" />');
...
// 22. Order
        ...
        methods_order = {
             ...
             */
                ...
                $.post(ajaxSendURL, { vehicle_id: ID,
                    ...
                    $('#DOPBCPCalendar-submit'+ID).attr('disabled', false);
