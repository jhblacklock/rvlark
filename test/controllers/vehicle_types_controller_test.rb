...
class VehicleTypesControllerTest < ActionController::TestCase
  ...
  test "should create vehicle_type" do
    assert_difference('VehicleType.count') do
      post :create, vehicle_type: { description: @vehicle_type.description, name: @vehicle_type.name, slug: @vehicle_type.slug, tagline: @vehicle_type.tagline }
    end
  ...
  test "should update vehicle_type" do
    patch :update, id: @vehicle_type, vehicle_type: { description: @vehicle_type.description, name: @vehicle_type.name, slug: @vehicle_type.slug, tagline: @vehicle_type.tagline }
    assert_redirected_to vehicle_type_path(assigns(:vehicle_type))
  end
